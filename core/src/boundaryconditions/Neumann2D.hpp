#ifndef EMPIRICAL_SRC_BOUNDARY_CONDITIONS_NEUMANN_2D_HPP_
#define EMPIRICAL_SRC_BOUNDARY_CONDITIONS_NEUMANN_2D_HPP_
...
#endif /* EMPIRICAL_SRC_BOUNDARY_CONDITIONS_NEUMANN_2D_HPP_ */

#ifndef EMPIRICAL_SRC_QUADRATURE_PERIODIC_TRAPEZOID_HPP_
#define EMPIRICAL_SRC_QUADRATURE_PERIODIC_TRAPEZOID_HPP_
...
#endif /* EMPIRICAL_SRC_QUADRATURE_PERIODIC_TRAPEZOID_HPP_ */

#ifndef EMPIRICAL_QUADRATURE_LEGENDRE_GAUSS_LOBATTO_HPP_
#define EMPIRICAL_QUADRATURE_LEGENDRE_GAUSS_LOBATTO_HPP_
...
#endif /* EMPIRICAL_QUADRATURE_LEGENDRE_GAUSS_LOBATTO_HPP_ */
